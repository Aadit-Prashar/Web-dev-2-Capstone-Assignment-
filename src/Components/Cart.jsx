...
export default function Cart() {
  ...
  if (cartItems.length === 0) {
    return (
      <div style={{ textAlign: "center", padding: "80px 24px", color: "#555", background: "#f3f3f3", minHeight: "100vh" }}>
    ...
    <div className="cart">
      ...
      <div className="cart__layout">
          ...
          {cartItems.map((item) => (
            <div key={item.id} className="cart__item">
              ...
              <div className="cart__item-details">
                ...
                <p className="cart__item-price">${item.price.toFixed(2)} each</p>
        ...
        <div className="cart__summary">
          ...
          <div className="cart__summary-row">
            <span>Shipping</span>
            <span style={{ color: "#067D62", fontWeight: "600" }}>FREE</span>
          </div>
